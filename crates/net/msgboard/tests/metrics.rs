...
fn every_metric_is_instantiated_and_moves() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            "msgboard.peer_sessions",
            "msgboard.peer_sessions_closed",
            "msgboard.peer_sessions_opened",
            "msgboard.peer_unsupported",
            ...
            "msgboard.rpc_subscriptions",
            "msgboard.rpc_subscriptions_closed",
            "msgboard.rpc_subscriptions_opened",
